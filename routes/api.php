...
Route::middleware('api.jwt')->group(function () {
    ...
    Route::prefix('cities')->withoutMiddleware(['api.jwt'])->group(function () {
        Route::get('/', [CityController::class, 'listAll'])->name('cities.listAll');
    });

    Route::prefix('clients')->withoutMiddleware(['api.jwt'])->group(function () {
        Route::get('/', [ClientController::class, 'findAllCLients'])->name('clients.listAll');
    ...
    Route::prefix('representatives')->withoutMiddleware(['api.jwt'])->group(function () {
        Route::get('/', [RepresentativeController::class, 'findAllRepresentatives'])->name('representatives.listAll');
